...
import { URL_BASE } from "../config/URL_BASE";
  ...
  const AddAutor = () => {
    ...
    const handleSubmit = async () => {
      const credentials = await Keychain.getGenericPassword();  // Modificación
      const token = credentials ? credentials.password : null;  // Modificación
      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          <View style={styles.containerImg}>
            <Image
              style={styles.img}
              source={require("../../appMovilRepo/assets/iconos/autor.png")}
            ></Image>
          </View>
          <SafeAreaView>
            <TextInput
